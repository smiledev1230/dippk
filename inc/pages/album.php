...
<div class="vim_control">
    ...
    if( in_array( @$active_doc, $mycontent->dashboard['favorites'] ) ) {
		?><div id="afav<?=@$active_doc?>" class="btn_fav_main <!-- btn_main_active link_favorites --> fright" style="margin-right:120px;"><div class="vim_text">FAVORITES</div></div><?
	} else {
		?><div id="afav<?=@$active_doc?>" class="btn_fav_main fright" style="margin-right:120px;"><div class="vim_text">FAVORITES</div><div class="tt_img hidden"></div></div><?
	}
	?>
