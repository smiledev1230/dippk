...
<form method="post" class="mycontent">
    ...
    <a  class="link-btn fright" style="margin-left:15px;" href="?page=account&view=uploads&ctab=quiz&form=question&quiz=<?php echo $quiz['ID'];?>">Add a Question to This Quiz</a>
