<div class="title">Add Video Form</div>
<form enctype="multipart/form-data" class="add_form">
    ...
    <input type="submit" onClick="alert('Sorry. For security reasons, uploads cannot be performed on this demo.');" name="process" class="fright" value="Add Video">
</form>